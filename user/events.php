...
if ($_SESSION['role'] !== 'student') {
    ...
    header('location:login.php'); // Replace 'restricted.php' with the appropriate page
    exit();
}
...
<body>
    ...
    <a href="./home.php">Home</a>
        ...
        <a href="./ScheduleDetails.php">Schedule Details</a>
        <a href="./request.php">Request</a>
        <a href="./admin/winners.php">Winners</a>
